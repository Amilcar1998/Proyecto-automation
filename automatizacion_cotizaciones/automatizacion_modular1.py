...
def main():
    ...
    try:
        ...
        for i, (cotizacion_id, productos) in enumerate(cotizaciones.items(), 1):
            ...
            tipo_entrega = config.get('tipo_entrega', 'cliente llevará')
            ...
            modulo_7_aplicar_credito()  # Función deshabilitada
            
            # PASO 10: APLICAR CRÉDITOS
            LOGGER.info("=== PASO 10: CRÉDITOS ===")
            modulo_8_aplicar_descuento_empleado()  # Función deshabilitada
