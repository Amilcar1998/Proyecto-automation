...
from SOL.SOL_SKU import SOLSKUClass, ejecutar_busqueda_sku_sol
...
def buscar_skus_individuales(driver, lista_skus):
    ...
    """
    try:
        print("\n🚀 Iniciando automatización SOL - Búsqueda de SKUs")
        print("="*70)
        ...
        # Crear instancia de SOLSKUClass para usar los métodos de búsqueda
        sol_sku = SOLSKUClass(driver)
        
        # Procesar la lista de SKUs
        resultados = sol_sku.procesar_lista_skus(lista_skus, intervalo_segundos=3)
...
def buscar_sku_individual(driver, numero_sku):
    ...
    """
    try:
        print("\n🚀 Iniciando automatización SOL - Búsqueda de SKU")
        print("="*70)
        ...
        # Buscar el SKU
        sol_sku = SOLSKUClass(driver)
        resultado = sol_sku.buscar_sku_por_numero(numero_sku)
...
if __name__ == "__main__":
    print("""
    ╔══════════════════════════════════════════════════════╗
    ║     AUTOMATIZACIÓN SOL - BÚSQUEDA DE SKUs            ║
    ╚══════════════════════════════════════════════════════╝
    """)
